...
- [os-step-ca](https://github.com/insipx/os-step-ca) opnsense plugin to use the `step-cli` through opnsense gui and renew certs
- [website](https://github.com/insipx/website) personal/portfolio site
<!--
